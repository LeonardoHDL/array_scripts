...
#this script is meant to automatize a whole Array analysis
...
outdirectory='/mnt/Guanina/cvan/data/Keloids_F2/Analysis/leo_analysis/'



path_to_extrafiles='/mnt/Guanina/cvan/data/Keloids_F2/Analysis/leo_analysis/Exome_Analysis/20230227_PCA_results_and_extrafiles/'
...
input_file=/mnt/Guanina/cvan/data/Keloids_F2/Array/UCHC_Freeze_Two.GT_hg38.pVCF
export input_file
...
#only removing_complexes.sh, pca.sh, and LD prunning can be commented, the others are necessary these files must be store in the same folder 
# for array is not necessary to revome high LD complexes
